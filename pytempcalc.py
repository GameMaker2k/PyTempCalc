...
def ConvertTempUnits(
        Temperature,
        InTempUnit="Fahrenheit",
        OutTempUnit="Celsius"):
...
def WindChill(
    ...
    if (TempUnit == "Fahrenheit" and WindUnit == "MPH"):
        if (NewWindChill):
            ...
            windchill = float(0.0817 *
                              (3.71 *
                               (math.sqrt(float(WindSpeed))) +
                                  5.81 -
                                  0.25 *
                                  float(WindSpeed)) *
                              (float(Temperature) -
    ...
    if (TempUnit == "Celsius" and WindUnit == "KMH"):
        if (NewWindChill):
            ...
            Temperature = ConvertTempUnits(
                float(Temperature), "Celsius", "Fahrenheit")['FahrenheitFull']
            windchill = float(0.0817 *
                              (3.71 *
                               (math.sqrt(float(WindSpeed))) +
                                  5.81 -
                              ...
                              91.4)
            Temperature = ConvertTempUnits(
                float(Temperature), "Fahrenheit", "Celsius")['CelsiusFull']
        windchillret.update({
        ...
        while (tempstart >= mintemp):
            ...
            if ((windstart == 5 and tempstart <= 40 and tempstart >= -5) or
               ...
               (windstart == 60 and tempstart <= 40 and tempstart >= 15)):
                windchillout = windchillout + " <wcc windspeedmph=\"" + str(
                    getwuval['MPHRounded']) + "\" windspeedkhm=\"" + str(
                    getwuval['KMHRounded']) + "\" windspeedknots=\"" + str(
                    getwuval['NMPHRounded']) + "\" temperaturef=\"" + str(
                    gettuval['FahrenheitRounded']) + "\" temperaturec=\"" + str(
                    gettuval['CelsiusRounded']) + "\" temperaturer=\"" + str(
                        gettuval['RankineRounded']) + "\" temperaturek=\"" + str(
                            gettuval['KelvinRounded']) + "\" temperatured=\"" + str(
                                gettuval['DelisleRounded']) + "\" temperaturen=\"" + str(
                                    gettuval['NewtonRounded']) + "\" temperaturere=\"" + str(
                                        gettuval['ReaumurRounded']) + "\" temperaturero=\"" + str(
                                            gettuval['RomerRounded']) + "\" windchillf=\"" + str(
                                                getwcval['FahrenheitRounded']) + "\" windchillc=\"" + str(
                                                    getwcval['CelsiusRounded']) + "\" windchillr=\"" + str(
                                                        getwcval['RankineRounded']) + "\" windchillk=\"" + str(
                                                            getwcval['KelvinRounded']) + "\" windchilld=\"" + str(
                                                                getwcval['DelisleRounded']) + "\" windchilln=\"" + str(
                                                                    getwcval['NewtonRounded']) + "\" windchillre=\"" + str(
                                                                        getwcval['ReaumurRounded']) + "\" windchillro=\"" + str(
                                                                            getwcval['RomerRounded']) + "\" frostbitelevel=\"0\" frostbitemin=\"-1\" />\n"
                                                        ...
                                                        getwcval['RankineRounded']) + "\" windchillk=\"" + str(
                                                            getwcval['KelvinRounded']) + "\" windchilld=\"" + str(
                                                                getwcval['DelisleRounded']) + "\" windchilln=\"" + str(
                                                                    getwcval['NewtonRounded']) + "\" windchillre=\"" + str(
                                                                        getwcval['ReaumurRounded']) + "\" windchillro=\"" + str(
                                                                            getwcval['RomerRounded']) + "\" frostbitelevel=\"1\" frostbitemin=\"30\" />\n"
                                                        ...
                                                        getwcval['RankineRounded']) + "\" windchillk=\"" + str(
                                                            getwcval['KelvinRounded']) + "\" windchilld=\"" + str(
                                                                getwcval['DelisleRounded']) + "\" windchilln=\"" + str(
                                                                    getwcval['NewtonRounded']) + "\" windchillre=\"" + str(
                                                                        getwcval['ReaumurRounded']) + "\" windchillro=\"" + str(
                                                                            getwcval['RomerRounded']) + "\" frostbitelevel=\"2\" frostbitemin=\"10\" />\n"
                                                        ...
                                                        getwcval['RankineRounded']) + "\" windchillk=\"" + str(
                                                            getwcval['KelvinRounded']) + "\" windchilld=\"" + str(
                                                                getwcval['DelisleRounded']) + "\" windchilln=\"" + str(
                                                                    getwcval['NewtonRounded']) + "\" windchillre=\"" + str(
                                                                        getwcval['ReaumurRounded']) + "\" windchillro=\"" + str(
                                                                            getwcval['RomerRounded']) + "\" frostbitelevel=\"3\" frostbitemin=\"5\" />\n"
...
def HeatIndexByDewPoint(Temperature, DewPointTemp, TempUnit="Fahrenheit"):
    ...
    if (TempUnit == "Celsius"):
        Temperature = ConvertTempUnits(
            float(Temperature),
            "Celsius",
            "Fahrenheit")['FahrenheitFull']
        DewPointTemp = ConvertTempUnits(
            float(DewPointTemp),
            "Celsius",
            "Fahrenheit")['FahrenheitFull']
        TempUnit = "Fahrenheit"
    if (TempUnit == "Fahrenheit"):
        ...
        if (hifinal > 79.0):
            ...
            if ((RHumidity2 <= 13.0) and (Temperature >= 80.0)
...
def HeatIndexByRelativeHumidity(Temperature, Humidity, TempUnit="Fahrenheit"):
    ...
    if (TempUnit == "Fahrenheit"):
        ...
        if (hifinal > 79.0):
            ...
            if ((float(Humidity) <= 13) and (float(Temperature) >= 80.0)
                    and (float(Temperature) <= 112.0)):
        ...
        while (tempstart <= maxtemp):
            ...
            if ((humidstart == 40 and tempstart >= 80 and tempstart <= 88) or
               ...
               (humidstart == 100 and tempstart >= 80 and tempstart <= 80)):
                humidityout = humidityout + " <hic temperaturef=\"" + str(
                    gettuval['FahrenheitRounded']) + "\" temperaturec=\"" + str(
                    gettuval['CelsiusRounded']) + "\" temperaturer=\"" + str(
                    gettuval['RankineRounded']) + "\" temperaturek=\"" + str(
                    gettuval['KelvinRounded']) + "\" temperatured=\"" + str(
                    gettuval['DelisleRounded']) + "\" temperaturen=\"" + str(
                        gettuval['NewtonRounded']) + "\" temperaturere=\"" + str(
                            gettuval['ReaumurRounded']) + "\" temperaturero=\"" + str(
                                gettuval['RomerRounded']) + "\" humidity=\"" + str(humidstart) + "\" humidityf=\"" + str(
                                    getwcval['FahrenheitRounded']) + "\" humidityc=\"" + str(
                                        getwcval['CelsiusRounded']) + "\" humidityr=\"" + str(
                                            getwcval['RankineRounded']) + "\" humidityk=\"" + str(
                                                getwcval['KelvinRounded']) + "\" humidityd=\"" + str(
                                                    getwcval['DelisleRounded']) + "\" humidityn=\"" + str(
                                                        getwcval['NewtonRounded']) + "\" humidityre=\"" + str(
                                                            getwcval['ReaumurRounded']) + "\" humidityro=\"" + str(
                                                                getwcval['RomerRounded']) + "\" heatlevelnum=\"0\" heatlevel=\"Caution\" />\n"
                                            ...
                                            getwcval['RankineRounded']) + "\" humidityk=\"" + str(
                                                getwcval['KelvinRounded']) + "\" humidityd=\"" + str(
                                                    getwcval['DelisleRounded']) + "\" humidityn=\"" + str(
                                                        getwcval['NewtonRounded']) + "\" humidityre=\"" + str(
                                                            getwcval['ReaumurRounded']) + "\" humidityro=\"" + str(
                                                                getwcval['RomerRounded']) + "\" heatlevelnum=\"1\" heatlevel=\"Extreme Caution\" />\n"
                                            ...
                                            getwcval['RankineRounded']) + "\" humidityk=\"" + str(
                                                getwcval['KelvinRounded']) + "\" humidityd=\"" + str(
                                                    getwcval['DelisleRounded']) + "\" humidityn=\"" + str(
                                                        getwcval['NewtonRounded']) + "\" humidityre=\"" + str(
                                                            getwcval['ReaumurRounded']) + "\" humidityro=\"" + str(
                                                                getwcval['RomerRounded']) + "\" heatlevelnum=\"2\" heatlevel=\"Danger\" />\n"
                                            ...
                                            getwcval['RankineRounded']) + "\" humidityk=\"" + str(
                                                getwcval['KelvinRounded']) + "\" humidityd=\"" + str(
                                                    getwcval['DelisleRounded']) + "\" humidityn=\"" + str(
                                                        getwcval['NewtonRounded']) + "\" humidityre=\"" + str(
                                                            getwcval['ReaumurRounded']) + "\" humidityro=\"" + str(
                                                                getwcval['RomerRounded']) + "\" heatlevelnum=\"3\" heatlevel=\"Extreme Danger\" />\n"
